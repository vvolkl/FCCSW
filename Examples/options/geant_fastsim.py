...
guntool = ConstPtParticleGun()
guntool.EtaMin = 0.0
guntool.EtaMax = 5.
guntool.PtMin = 0.01*units.GeV
guntool.PtMax = 10*units.GeV
...
regiontooltracker.maxEta = 10
regiontooltracker.maxMomentum = 10*units.TeV
