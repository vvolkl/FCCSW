#ifndef RECCALORIMETER_CALOTOWERTOOLBARREL_H
#define RECCALORIMETER_CALOTOWERTOOLBARREL_H
...
/** @class TowerToolBarrel Reconstruction/RecCalorimeter/src/components/TowerToolBarrel.h
 * TowerToolBarrel.h
 *
...
class TowerToolBarrel : public GaudiTool, virtual public ITowerTool {
public:
  TowerToolBarrel(const std::string& type, const std::string& name, const IInterface* parent);
  virtual ~TowerToolBarrel() = default;
  /**  Initialize.
   *   @return status code
   */
