...
/** @class MaterialScanCosTheta Detector/DetComponents/src/MaterialScanCosTheta.h MaterialScanCosTheta.h
 *
...
class MaterialScanCosTheta : public Service {
public:
  explicit MaterialScanCosTheta(const std::string& name, ISvcLocator* svcLoc);

  virtual StatusCode initialize();
  virtual StatusCode finalize();
  virtual ~MaterialScanCosTheta(){};
...
private:
  ...
  /// Step size in eta
  Gaudi::Property<double> m_cosThetaBinning{this, "cosThetaBinning", 0.05, "eta bin size"};
  /// Maximum eta until which to scan, scan is performed from -m_etaMax to +m_etaMax
  Gaudi::Property<double> m_cosThetaMax{this, "cosThetaMax", 1, "maximum eta value"};
